...
git clone --depth 1 --branch master https://github.com/bilel/kafka-docker.git
cd kafka-docker
...
docker cp /Users/bilel/Documents/projects/spring_kafka_demo/build/libs/spring-kafka-demo-1.0.0.jar testapp:/spring-kafka-demo-1.0.0.jar
